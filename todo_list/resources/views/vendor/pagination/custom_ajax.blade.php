        ...
        <nav class="inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            @else
                <a href="{{ $paginator->previousPageUrl() }}" 
                   ...
                   class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-500 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 dark:ring-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800">
                    <span class="sr-only">Previous</span>
                    <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd" d="M11.78 5.22a.75.75 0 0 1 0 1.06L8.06 10l3.72 3.72a.75.75 0 1 1-1.06 1.06l-4.25-4.25a.75.75 0 0 1 0-1.06l4.25-4.25a.75.75 0 0 1 1.06 0Z" clip-rule="evenodd" />
                    </svg>
                    ...
                    @foreach ($element as $page => $url)
                        ...
                        @else
                            <a href="{{ $url }}" 
                               ...
                               class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 dark:ring-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800">
                                {{ $page }}
                            </a>
                        @endif
                    @endforeach
            ...
            @if ($paginator->hasMorePages())
                <a href="{{ $paginator->nextPageUrl() }}" 
                   data-action="paginate" data-page="{{ $paginator->currentPage() + 1 }}"
                   class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-500 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 dark:ring-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800">
